...
void cadastro(int id[], int vacina[], char email[][100], char nome[][100], char sexo[][3], char endereco[][300], double altura[], int pessoa[]);

void editar (int id[], int vacina[], char email[][100], char nome[][100], char sexo[][3], char endereco[][300], double altura[], int pessoa[]);
...
do {
	...
	switch(menu){
		...
		case 1 :
			...
			printf("---------------------------    Cadastro       ------------------------------\n\n");
			cadastro(id,vacina,email,nome,sexo,endereco,altura,pessoa);
			break;
		
		case 2:

			printf("-------------------------      Editar     ------------------------------------\n\n");
			editar(id,vacina,email,nome,sexo,endereco,altura,pessoa);
			break;
...
while (nome_ou_email!=1 && nome_ou_email!=2 ){
	...
	printf("Digite - (1) PESQUISAR PELO NOME / (2) PESQUISAR NA LISTA DE CADASTRO: \n\n");
